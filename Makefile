...
#	cd $(OUTPUTDIR);git pull;ghp-import -pr $(GITHUB_PAGES_REPO)
...
github: publish
	ghp-import -m $(GITHUB_PAGES_UPDATE_MSG) $(OUTPUTDIR)
	#git push $(GITHUB_PUSH_OPTIONS) $(GITHUB_PAGES_REPO) gh-pages:$(GITHUB_PAGES_BRANCH)
	cd $(OUTPUTDIR);git checkout  gh-pages;git add -A;git commit -am "add new files";git push origin gh-pages:$(GITHUB_PAGES_BRANCH)
